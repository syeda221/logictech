...
Route::middleware('auth')->group(function () {
    ...
    // ============================================================
    // MANUFACTURING PURCHASE MANAGEMENT MODULE
    // ============================================================
    ...
    Route::post('/grn', [\App\Http\Controllers\GrnController::class, 'store'])
        ->middleware('permission:purchases.create')->name('grn.store');
    Route::get('/grn/{id}', [\App\Http\Controllers\GrnController::class, 'show'])
        ->middleware('permission:purchases.view')->name('grn.show');
    Route::post('/grn/{id}/qc-reject', [\App\Http\Controllers\GrnController::class, 'qcReject'])
        ->middleware('permission:purchases.edit')->name('grn.qc-reject');
    Route::post('/grn/{grnId}/debit-note', [\App\Http\Controllers\GrnController::class, 'createDebitNote'])
        ->middleware('permission:purchases.create')->name('grn.create-debit-note');
    Route::delete('/grn/{id}', [\App\Http\Controllers\GrnController::class, 'destroy'])
        ->middleware('permission:purchases.delete')->name('grn.destroy');

    // Import Shipment Costs / Landed Cost Calculator
    Route::get('/import-costs/{purchaseId}', [\App\Http\Controllers\ImportShipmentCostController::class, 'show'])
        ->middleware('permission:purchases.view')->name('import-costs.show');
    Route::post('/import-costs/{purchaseId}', [\App\Http\Controllers\ImportShipmentCostController::class, 'store'])
        ->middleware('permission:purchases.edit')->name('import-costs.store');
    Route::get('/import-costs/{purchaseId}/calculate', [\App\Http\Controllers\ImportShipmentCostController::class, 'calculate'])
        ->middleware('permission:purchases.view')->name('import-costs.calculate');
