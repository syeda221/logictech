        ...
        <div class="main-content-inner">
          ...
          font-size: 14px;
                            ...
                            <div class="gp-header row align-items-center mb-2">
                                ...
                                <div class="col-md-4">
                                    <div class="gp-title">
                                        <h5 class="mb-0 fw-semibold" style="font-size:18px"><i class="fas fa-industry text-primary me-2"></i>LogicTech — Inward Purchase Order</h5>
                                        <small class="text-muted">Industrial procurement &amp; raw material intake</small>
                                    </div>
                                </div>
