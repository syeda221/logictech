                ...
                <div class="card-panel shadow-sm mb-3 p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <h4 class="header-text text-dark fw-bold mb-0 ms-2"><i class="fas fa-industry text-primary me-2"></i>LogicTech — Purchase Order Entry</h4>
                        </div>
                        <div>
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-2">
                            ...
                            <select class="form-select" name="purchase_type" id="purchaseTypeSelect">
                                <option value="local" selected>🇵🇰 Local Purchase</option>
                    ...
                    <div id="importProcurementFields" class="mt-3 p-3 border rounded-3 bg-light d-none">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" step="0.000001" name="exchange_rate" class="form-control form-control-sm" value="1.000000">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label fw-bold mb-1 text-muted small">Proforma Inv #</label>
                                <input type="text" name="proforma_invoice_no" class="form-control form-control-sm" placeholder="PI-...">
                            </div>
                            <div class="col-md-2">
