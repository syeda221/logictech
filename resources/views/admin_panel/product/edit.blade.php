    ...
    <div class="page-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h5 class="fw-bold mb-0 text-dark"><i class="fas fa-microchip text-primary me-2"></i>Edit Product / Component</h5>
                    <small class="text-muted" style="font-size:0.8rem;">LogicTech Industrial ERP — Update component specifications and inventory settings</small>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="btn-group w-100 p-1 bg-light rounded-3 border" role="group" aria-label="Item Classification">
                                                <input type="radio" class="btn-check" name="item_type" id="type_raw_material" value="raw_material" autocomplete="off" {{ ($product->item_type ?? 'raw_material') === 'raw_material' ? 'checked' : '' }}>
                                                ...
                                                <input type="radio" class="btn-check" name="item_type" id="type_finish_goods" value="finish_goods" autocomplete="off" {{ ($product->item_type ?? '') === 'finish_goods' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control-pro fs-6 fw-bold" name="product_name" required value="{{ $product->item_name }}" placeholder="e.g. High Frequency Induction Heater 25kW, Air Chiller 5TR, IGBT Module 1200V">
                                        </div>
                                        <div class="col-md-4">
