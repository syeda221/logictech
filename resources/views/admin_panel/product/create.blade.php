...
@section('content')
    ...
    <style>
        ...
        /* Segmented Item Type Toggle */
        .btn-check:checked + label[for="type_raw_material"] {
            background-color: #f59e0b !important;
            border-color: #f59e0b !important;
            color: #ffffff !important;
            box-shadow: 0 2px 6px rgba(245, 158, 11, 0.35);
        }
        .btn-check:checked + label[for="type_raw_material"] i {
            color: #ffffff !important;
        }

        .btn-check:checked + label[for="type_finish_goods"] {
            background-color: #10b981 !important;
            border-color: #10b981 !important;
            color: #ffffff !important;
            box-shadow: 0 2px 6px rgba(16, 185, 129, 0.35);
        }
        .btn-check:checked + label[for="type_finish_goods"] i {
            color: #ffffff !important;
        }

        .btn-check:checked + label[for="type_both"] {
            background-color: #4f46e5 !important;
            border-color: #4f46e5 !important;
            color: #ffffff !important;
            box-shadow: 0 2px 6px rgba(79, 70, 229, 0.35);
        }
        .btn-check:checked + label[for="type_both"] i {
            color: #ffffff !important;
        }
    ...
    <div class="page-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h5 class="fw-bold mb-0 text-dark"><i class="fas fa-microchip text-primary me-2"></i>Create Product / Component</h5>
                    <small class="text-muted" style="font-size:0.8rem;">LogicTech Industrial ERP — Add heating devices, chillers, power electronics, or raw materials</small>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="section-card">
                        <div class="card-header-pro">
                            <h5 class="card-title-pro"><i class="fas fa-microchip text-primary"></i> Product &amp; Component Identity</h5>
                        </div>
                        <div class="card-body-pro">
                            <div class="row g-3">
                                ...
                                <div class="col-md-9">
                                    <div class="row g-3">
                                        {{-- Item Type Toggle: Raw Material / Finished Goods --}}
                                        <div class="col-md-12">
                                            <label class="form-label-pro d-flex align-items-center justify-content-between mb-1">
                                        ...
                                        <div class="col-md-12">
                                            <label class="form-label-pro">Product / Component Name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control-pro fs-6 fw-bold" name="product_name" required placeholder="e.g. High Frequency Induction Heater 25kW, Industrial Air Chiller 5TR, IGBT Module 1200V">
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-sm align-middle mb-1" id="variantsTable">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th class="text-uppercase text-muted p-1" style="min-width: 140px; font-size: 10px;">Variant / Part Name</th>
                ...
                <div class="modal-content border-0 shadow-lg" style="border-radius: var(--radius-md);">
                    <form action="{{ route('store.Brand') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="page" value="product_page">
                            <div class="mb-3">
                                <label class="form-label-pro">Brand / Manufacturer Name</label>
                                <input type="text" name="name" class="form-control-pro" required placeholder="e.g. LogicTech, Danfoss, Infineon, Semikron">
                            </div>
            ...
            function addBaseVariantRow() {
                ...
                tr.innerHTML = `
                    ...
                    <td class="p-1 stock-col">
                        <input type="number" class="form-control-pro form-control-sm text-center fw-bold text-primary stock-input" name="variant_stock[]" step="any" value="0" placeholder="0" title="${isCartonMode ? 'Initial Stock (Cartons)' : 'Initial Stock'}">
                    </td>
                    ...
                    <td class="p-1 purch-col"><input type="number" class="form-control-pro form-control-sm base-purch-input" name="variant_purchase_price[]" step="any" placeholder="0.00"></td>
                    <td class="p-1 alert-col"><input type="number" class="form-control-pro form-control-sm" name="variant_alert_qty[]" value="0" placeholder="0"></td>
